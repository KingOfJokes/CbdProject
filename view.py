...
def main(ver,chithresh):
	#length = 850
	#ver = 'all3y_5d1atr5'
	dfthresh = 1
	xt = np.load('./0504/output_X_'+ver+'_ddc'+str(dfthresh)+str(chithresh)+'.npy',allow_pickle = True)
	yt = np.load('./0504/output_Y_'+ver+'_ddc'+str(dfthresh)+str(chithresh)+'.npy',allow_pickle = True)
	yt = np.array(yt)
	print(type(yt))
	...
	np.save('./0504/output_Xa_'+ver+'_ddc'+str(dfthresh)+str(chithresh)+'.npy',xt)
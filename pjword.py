...
#合併三個文章檔案
collections = pd.concat([news],axis=0, ignore_index=True,sort=False)
...
np.save('./output_X_news_3d1.5sigma.npy', output_x_numpy)
np.save('./output_Y_news_3d1.5sigma.npy', output_y_numpy)

with open('increaseword_news_3d1.5sigma.pkl', 'wb') as f: 
    pickle.dump(increase_keyword, f)
with open('decreaseword_news_3d1.5sigma.pkl', 'wb') as f: 

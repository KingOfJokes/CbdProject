...
#讀入指數價格資料
Indexprice = pd.read_excel('./Index_10.xlsx')
#Indexprice
...
def main(day,multi,ver):
    ...
    np.save('./0504/output_X_'+ver+'_dc'+str(dfthresh)+str(chithresh)+'.npy', output_x_numpy)
    np.save('./0504/output_Y_'+ver+'_dc'+str(dfthresh)+str(chithresh)+'.npy', output_y_numpy)
